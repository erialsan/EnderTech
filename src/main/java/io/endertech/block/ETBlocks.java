...
public class ETBlocks {
    ...
    public static void init() {
        ...
        GameRegistry
            .registerBlock(blockTankPart, ItemBlockTankPart.class, "endertech." + Strings.Blocks.TANK_PART_NAME);
        GameRegistry.registerBlock(
            blockMultiblockGlass,
            ItemBlockBasic.class,
            "endertech." + Strings.Blocks.MULTIBLOCK_GLASS_NAME);
        GameRegistry.registerBlock(
            blockTankController,
            ItemBlockBasic.class,
            "endertech." + Strings.Blocks.TANK_CONTROLLER_NAME);
