...
public abstract class IMultiblockPart extends TileET {
    ...
    /**
     * Returns the location of this tile entity in the world, in BlockCoord form.
     *
     * @return A BlockCoord with its x,y,z members set to the location of this tile entity in the world.
     */
    public abstract BlockCoord getWorldLocation();
