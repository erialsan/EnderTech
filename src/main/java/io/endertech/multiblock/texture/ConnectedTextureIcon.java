...
public class ConnectedTextureIcon implements IIcon {
    ...
    public static final String[] ICON_TYPES = { "central", "top", "bottom", "left", "right", "anticorner.tl",
        "anticorner.tr", "anticorner.br", "anticorner.bl" };
    ...
    public int getIconWidth() {
        return this.getCurrentRenderIcon()
            .getIconWidth();
    }
