...
public class TileTankPart extends TileTankPartBase implements IOutlineDrawer {
    ...
    public void isGoodForFrame() throws MultiblockValidationException {
        ...
        throw new MultiblockValidationException(
            LocalisationHelper.localiseString("info.multiblock.tank.part.unsuitable.frame", xCoord, yCoord, zCoord));
    }
    ...
    public void isGoodForTop() throws MultiblockValidationException {
        ...
        throw new MultiblockValidationException(
            LocalisationHelper.localiseString("info.multiblock.tank.part.unsuitable.top", xCoord, yCoord, zCoord));
    }
    ...
    public void isGoodForBottom() throws MultiblockValidationException {
        ...
        throw new MultiblockValidationException(
            LocalisationHelper.localiseString("info.multiblock.tank.part.unsuitable.bottom", xCoord, yCoord, zCoord));
    }

    @Override
    public void isGoodForInterior() throws MultiblockValidationException {
        throw new MultiblockValidationException(
            LocalisationHelper.localiseString("info.multiblock.tank.part.unsuitable.interior", xCoord, yCoord, zCoord));
    }
        ...
        if (getBlockType() == ETBlocks.blockTankController) {
            ...
            if (BlockTankController.isController(metadata)) {
                this.worldObj.setBlockMetadataWithNotify(
                    ...
                    this.yCoord,
                    this.zCoord,
                    BlockTankController.CONTROLLER_ACTIVE,
                    2);
            }
        }
    }
        ...
        if (getBlockType() == ETBlocks.blockTankController) {
            ...
            if (BlockTankController.isController(metadata)) {
                this.worldObj.setBlockMetadataWithNotify(
                    ...
                    this.yCoord,
                    this.zCoord,
                    BlockTankController.CONTROLLER_IDLE,
                    2);
            }
        }
    }
    ...
    public void onMachineAssembled(MultiblockControllerBase multiblockController) {
        ...
        if (multiblockController == null) {
            throw new IllegalArgumentException(
                "Being assembled into a null controller. This should never happen. Please report this stacktrace to http://github.com/Drayshak/EnderTech/");
        }

        if (this.getMultiblockController() == null) {
            LogHelper.warn(
                LocalisationHelper
                    .localiseString("warning.multiblock.tank.null_controller_assembly", xCoord, yCoord, zCoord));
        ...
        if (getBlockType() == ETBlocks.blockTankPart) {
            ...
            if (BlockTankPart.isFrame(metadata)) {
                this.worldObj.setBlockMetadataWithNotify(
                    ...
                    this.yCoord,
                    this.zCoord,
                    BlockTankPart.FRAME_METADATA_BASE,
                    2);
            }
        }
    }
    ...
    private void setCasingMetadataBasedOnWorldPosition() {
        ...
        if (extremes == 3) {
            // Corner
            this.worldObj
                .setBlockMetadataWithNotify(this.xCoord, this.yCoord, this.zCoord, BlockTankPart.FRAME_CORNER, 2);
        } else if (extremes == 2) {
            if (!xExtreme) {
                // Y/Z - must be east/west
                this.worldObj
                    .setBlockMetadataWithNotify(this.xCoord, this.yCoord, this.zCoord, BlockTankPart.FRAME_EASTWEST, 2);
            } else if (!zExtreme) {
                ...
                this.worldObj.setBlockMetadataWithNotify(
                    ...
                    this.yCoord,
                    this.zCoord,
                    BlockTankPart.FRAME_NORTHSOUTH,
                    2);
            } else {
                // Not a y-extreme, must be vertical
                this.worldObj
                    .setBlockMetadataWithNotify(this.xCoord, this.yCoord, this.zCoord, BlockTankPart.FRAME_VERTICAL, 2);
            }
        } else if (extremes == 1) {
            this.worldObj
                .setBlockMetadataWithNotify(this.xCoord, this.yCoord, this.zCoord, BlockTankPart.FRAME_CENTER, 2);
        } else {
    ...
    public PacketETBase getPacket() {
        ...
        if (isConnectedAndSaveDelegate) {
            return this.getTankController()
                .getPacket(tileBasePacket);
        } else {
    ...
    public void handleTilePacket(PacketETBase packetETBase, boolean isServer) {
        ...
        if (!isServer) {
            ...
            if (controller == null) {
                ...
                // LogHelper.info("Caching message for tank part tile: " + this.xCoord + ", " + this.yCoord + ", " +
                // this.zCoord);
            } else {
                controller.handleTilePacket(packetETBase, isServer);
                // LogHelper.info("Decoding message for controller: " + tile.xCoord + ", " + tile.yCoord + ", " +
                // tile.zCoord);
            }
        }
    }
    ...
    protected boolean canInteractFromDirection(ForgeDirection from) {
        return (isConnected() && this.getTankController()
            .isAssembled() && getOutwardsDir().contains(from));
    }
    ...
    public boolean hasGui() {
        return this.isConnected() && this.getMultiblockController()
            .isAssembled();
    }
}
