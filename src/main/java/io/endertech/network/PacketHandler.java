...
public class PacketHandler extends MessageToMessageCodec<FMLProxyPacket, PacketBase> {
        ...
        instance.channels.get(Side.SERVER)
            ...
            .set(
                new NetworkRegistry.TargetPoint(
                    ...
                    theTile.yCoord,
                    theTile.zCoord,
                    Reference.NETWORK_UPDATE_RANGE));
        instance.channels.get(Side.SERVER)
            .writeAndFlush(message);
    }
    ...
    public static void sendToAllAround(PacketBase message, World world, int x, int y, int z) {
        ...
        instance.channels.get(Side.SERVER)
            .attr(FMLOutboundHandler.FML_MESSAGETARGETARGS)
            .set(new NetworkRegistry.TargetPoint(world.provider.dimensionId, x, y, z, Reference.NETWORK_UPDATE_RANGE));
        instance.channels.get(Side.SERVER)
            .writeAndFlush(message);
    }
    ...
    public void postInit() {
        ...
        Collections.sort(this.packets, new Comparator<Class<? extends PacketBase>>() {
            ...
            public int compare(Class<? extends PacketBase> packetClass1, Class<? extends PacketBase> packetClass2) {
                ...
                int com = String.CASE_INSENSITIVE_ORDER
                    .compare(packetClass1.getCanonicalName(), packetClass2.getCanonicalName());
                if (com == 0) {
                    com = packetClass1.getCanonicalName()
                        .compareTo(packetClass2.getCanonicalName());
                }
                return com;
            }
        });
