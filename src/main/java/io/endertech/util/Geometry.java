...
public class Geometry {
    ...
    static {
        ...
        cubeFaces[FRONT_FACE] = new Vec3[] { cubeVertices[RIGHT_BOTTOM_FRONT], cubeVertices[RIGHT_BOTTOM_BACK],
            cubeVertices[LEFT_BOTTOM_BACK], cubeVertices[LEFT_BOTTOM_FRONT] };
        cubeFaces[BACK_FACE] = new Vec3[] { cubeVertices[RIGHT_TOP_BACK], cubeVertices[RIGHT_TOP_FRONT],
            cubeVertices[LEFT_TOP_FRONT], cubeVertices[LEFT_TOP_BACK] };
        cubeFaces[TOP_FACE] = new Vec3[] { cubeVertices[RIGHT_TOP_FRONT], cubeVertices[RIGHT_TOP_BACK],
            cubeVertices[RIGHT_BOTTOM_BACK], cubeVertices[RIGHT_BOTTOM_FRONT] };
        cubeFaces[BOTTOM_FACE] = new Vec3[] { cubeVertices[LEFT_TOP_BACK], cubeVertices[LEFT_TOP_FRONT],
            cubeVertices[LEFT_BOTTOM_FRONT], cubeVertices[LEFT_BOTTOM_BACK] };
        cubeFaces[RIGHT_FACE] = new Vec3[] { cubeVertices[RIGHT_BOTTOM_BACK], cubeVertices[RIGHT_TOP_BACK],
            cubeVertices[LEFT_TOP_BACK], cubeVertices[LEFT_BOTTOM_BACK] };
        cubeFaces[LEFT_FACE] = new Vec3[] { cubeVertices[RIGHT_BOTTOM_BACK], cubeVertices[RIGHT_BOTTOM_FRONT],
            cubeVertices[LEFT_BOTTOM_FRONT], cubeVertices[LEFT_TOP_FRONT] };
    }
