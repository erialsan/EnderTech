...
public class RenderHelper {
    ...
    public static void renderBlockOutline(RenderGlobal context, EntityPlayer entityPlayer, BlockCoord blockCoord,
        RGBA colour, float lineWidth, float partialTicks) {
        ...
        renderAABBOutline(
            context,
            entityPlayer,
            block.getSelectedBoundingBoxFromPool(entityPlayer.worldObj, blockCoord.x, blockCoord.y, blockCoord.z),
            colour,
            lineWidth,
            partialTicks);
    }

    public static void renderAABBOutline(RenderGlobal context, EntityPlayer entityPlayer, AxisAlignedBB aabb,
        RGBA colour, float lineWidth, float partialTicks) {
