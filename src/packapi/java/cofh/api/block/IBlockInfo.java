...
/**
 * Implement this interface on blocks which can provide information about themselves. If the block contains Tile
 * Entities, then it is recommended that this
...
public interface IBlockInfo {
     ...
     */
    void getBlockInfo(IBlockAccess world, int x, int y, int z, ForgeDirection side, EntityPlayer player,
