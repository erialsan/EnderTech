...
public class ThaumcraftHelper {
    ...
    static {
        l: try {
            ...
            aspects = (Map<String, ? extends Object>) Aspect.getDeclaredField("aspects")
                .get(null);
            ...
            registerEntity = ThaumcraftApi
                .getDeclaredMethod("registerEntityTag", String.class, AspectList, EntityTagsNBT);
