...
public interface IPortableData {
    ...
    /**
     * Data identifier of the Tile Entity/Block. Used for display as well as verification purposes. Tiles with
     * completely interchangeable data should return the
     * same type.
     *
     * @return
     */
