...
public interface IEnderItemHandler extends IEnderAttuned {
    ...
    /**
     * This tells the Ender Attuned object to receive an ItemStack. This returns what remains of the original stack,
     * *not* the amount received - a null return
     * means that the entire stack was received!
     *
     * This function does not support simulation because Inventory manipulation in Minecraft is an absolute mess and it
     * would be a computational liability to do
     * so.
     *
     * @param item
