...
public class ContainerInventoryItem extends Container {
    ...
    public void detectAndSendChanges() {
        ...
        if (item == null || item.getItem() != containerWrapper.getContainerStack()
            .getItem()) {
            valid = false;
            return;
        }
    ...
    public void onSlotChanged() {
        ...
        ItemStack item = player.inventory.mainInventory[containerIndex];
        if (valid && item != null
            && item.getItem() == containerWrapper.getContainerStack()
                .getItem()) {
    ...
    public ItemStack slotClick(int slotIndex, int mouseButton, int modifier, EntityPlayer player) {
        ...
        if (modifier == 5) {
                ...
                if (slotIndex == -999) {
                    ...
                    if (slot2 != null && slot2.canTakeStack(player)) {
                        ...
                        if (itemstack3 != null) {
                            ...
                            if (slot2.getStack() != null && slot2.getStack()
                                .getItem() == item) {
            ...
            } else if (modifier == 3 && player.capabilities.isCreativeMode
                        ...
                        for (int i2 = 0; i2 < 2; ++i2) {
                            for (int j2 = i1; j2 >= 0 && j2 < this.inventorySlots.size()
                                ...
                                if (slot3.getHasStack() && func_94527_a(slot3, itemstack3, true)
                                    ...
                                    && this.func_94530_a(itemstack3, slot3)
                                    && (i2 != 0 || slot3.getStack().stackSize != slot3.getStack()
                                        .getMaxStackSize())) {
                                    int k1 = Math.min(
