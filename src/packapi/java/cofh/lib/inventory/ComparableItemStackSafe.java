...
/**
 * This is basically a default "safe" implementation of a ComparableItemStack - the OreID will only be used for the 5
 * "basic" conventions.
 *
 * @author King Lemming
 *
...
public class ComparableItemStackSafe extends ComparableItemStack {
    ...
    public static boolean safeOreType(String oreName) {
        ...
        return oreName.startsWith(BLOCK) || oreName.startsWith(ORE)
