...
public class ClientEnderChannelRegistry implements IEnderChannelRegistry {
    ...
    @Override
    public List<Frequency> getFrequencyList(String channelName) {

        return list;
    }

    @Override
    public String getFrequency(String channelName, int freq) {

        return channel.get(freq);
    }

    @Override
    public String setFrequency(String channelName, int freq, String name) {
    ...
    @Override
    public String removeFrequency(String channelName, int freq) {
