...
public class ArrayHashList<E extends Object> extends AbstractCollection<E>
    ...
    private static int roundUpToPowerOf2(int number) {
        ...
        return number >= Ints.MAX_POWER_OF_TWO ? Ints.MAX_POWER_OF_TWO
    ...
    /**
     * Trims the capacity of this <tt>ArrayHashList</tt> instance to be the list's current size. An application can use
     * this operation to minimize the storage
    ...
    /**
     * Increases the capacity of this <tt>ArrayHashList</tt> instance, if necessary, to ensure that it can hold at least
     * the number of elements specified by the
     ...
     * larger arrays may result in OutOfMemoryError:
