...
public class EntityHelper {
    ...
    public static void transferEntityToDimension(Entity entity, int dimension, ServerConfigurationManager manager) {
        ...
        WorldServer worldserver = manager.getServerInstance()
            .worldServerForDimension(entity.dimension);
        entity.dimension = dimension;
        WorldServer worldserver1 = manager.getServerInstance()
            .worldServerForDimension(entity.dimension);
    ...
    public static void transferPlayerToDimension(EntityPlayerMP player, int dimension,
        ...
        FMLCommonHandler.instance()
            .firePlayerChangedDimensionEvent(player, oldDim, dimension);
    }
