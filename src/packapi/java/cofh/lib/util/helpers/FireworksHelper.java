...
public final class FireworksHelper {
            ...
            for (int i = 0; i < primaryColors; i++) {
                Color color = new Color(
                    Color.HSBtoRGB(
                        ...
                        MathHelper.RANDOM.nextFloat() * 0.15F + 0.8F,
                        0.85F));
    ...
    /**
     * Creates a fireworks {@link ItemStack}, with the resulting fireworks having a certain flight duration and a
     * variety of {@link Explosion}s.
     *
     * @param flightDuration
     *                       The flight duration of the fireworks. Possible range is between 0 (inclusive) and 3
     *                       (inclusive).
     * @param explosions
