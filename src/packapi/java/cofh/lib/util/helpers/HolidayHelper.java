...
/**
 * The class contains helper functions related to Holidays! The holidays intentionally begin a day before the actual
 * holiday and end one day after it.
 *
...
public class HolidayHelper {
    ...
    public static boolean isEaster() {
        ...
        /**
         * Compute the day of the year that Easter falls on. Step names E1 E2 etc., are direct references to Knuth, Vol
         * 1, p 155.
         *
