...
public final class ServerHelper {
     ...
     */
    public static final void sendItemUsePacket(ItemStack stack, EntityPlayer player, World world, int x, int y, int z,
        int hitSide, float hitX, float hitY, float hitZ) {
        ...
        netClientHandler.addToSendQueue(
            new C08PacketPlayerBlockPlacement(x, y, z, hitSide, player.inventory.getCurrentItem(), hitX, hitY, hitZ));
    }
