...
public final class StringHelper {
    ...
    public static String camelCase(String input) {
        ...
        return input.substring(0, 1)
            .toLowerCase(Locale.US) + input.substring(1);
    }

    public static String titleCase(String input) {

        return input.substring(0, 1)
            .toUpperCase(Locale.US) + input.substring(1);
    }
    ...
    public static String getKeyName(int key) {
        ...
        return key < 0 ? StatCollector.translateToLocalFormatted("key.mouseButton", key + 101)
    ...
    public static String shiftForDetails() {
        ...
        return LIGHT_GRAY + localize("info.cofh.hold")
            + " "
            + YELLOW
            + ITALIC
            + localize("info.cofh.shift")
            + " "
            + END
            + LIGHT_GRAY
            + localize("info.cofh.forDetails")
            + END;
    }
