...
public class WorldGenDungeon extends WorldGenerator {
    ...
    public WorldGenDungeon(List<WeightedRandomBlock> blocks, List<WeightedRandomBlock> material,
        List<WeightedRandomNBTTag> mobs) {
    ...
    public boolean generate(World world, Random rand, int xStart, int yStart, int zStart) {
                    ...
                    if (walls >= 1 && walls <= 2) {
                        ...
                        if (chest != null) {
                            WeightedRandomChestContent
                                .generateChestContents(rand, table.getItems(rand), chest, table.getCount(rand));
                        }
        ...
        if (spawner != null) {
            ...
            System.err
                .println("Failed to fetch mob spawner entity at (" + xStart + ", " + yStart + ", " + zStart + ")");
        }
