...
public class WorldGenSmallTree extends WorldGenerator {
    ...
    public WorldGenSmallTree(List<WeightedRandomBlock> resource, List<WeightedRandomBlock> leaf,
        ...
        if (y + treeHeight + 1 <= worldHeight) {
            ...
            if (y < worldHeight - treeHeight - 1) {
                            ...
                            if (((xPos != radius | zPos != radius)
                                ...
                                && ((treeChecks
                                    ? block.isLeaves(world, xOffset, yOffset, zOffset)
                                        || block.isAir(world, xOffset, yOffset, zOffset)
                                        || block.canBeReplacedByLeaves(world, xOffset, yOffset, zOffset)
                                    : false) || canGenerateInBlock(world, xOffset, yOffset, zOffset, genBlock))) {
                ...
                for (yOffset = 0; yOffset < treeHeight; ++yOffset) {
                    ...
                    if ((treeChecks
                        ? block.isAir(world, x, y + yOffset, z) || block.isLeaves(world, x, y + yOffset, z)
                            || block.isReplaceable(world, x, y + yOffset, z)
                        : false) || canGenerateInBlock(world, x, yOffset + y, z, genBlock)) {
