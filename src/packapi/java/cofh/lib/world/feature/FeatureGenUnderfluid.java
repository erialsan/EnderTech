...
public class FeatureGenUnderfluid extends FeatureBase {
    ...
    public FeatureGenUnderfluid(String name, WorldGenerator worldGen, List<WeightedRandomBlock> matList, int count,
    ...
    public FeatureGenUnderfluid(String name, WorldGenerator worldGen, List<WeightedRandomBlock> matList,
        int[] fluidList, int count, GenRestriction biomeRes, boolean regen, GenRestriction dimRes) {
